...
public class UsuarioDAO extends DAO<Usuario> {
	...
	public boolean create (Usuario usuario) {
		...
		sql.append("	(nome, login, senha, datanascimento, email, localregiao) ");
		sql.append("VALUES ");
		sql.append("	( ? , ? , ? , ? , ? , ? ) ");
		...
		try {
			...
			stat.setInt(6, usuario.getLocalRegiao().getId());
	...
	public boolean update(Usuario usuario) {
		...
		sql.append("	SET nome=?, login=?, senha=?, datanascimento=?, email=?, localregiao=? ");
		sql.append("WHERE ");
		sql.append("	id = ? ");
	...
	public List<Usuario> findAll() {
		...
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT ");
		sql.append(" 	id, nome, login, senha, datanascimento, email, localregiao ");
		sql.append("FROM ");
		sql.append("	usuario ");
		...
		try {
			...
			while(rs.next()) {
				...
				usuario.setLocalRegiao(LocalRegiao.valueOf(rs.getInt("localregiao")));
